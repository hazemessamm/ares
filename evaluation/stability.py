...
def main(cfg: DictConfig):
    print("Running stability evaluation on model: ", cfg.model.name, "with checkpoint: ", getattr(cfg, cfg.model.name).checkpoint, "and seed: ", cfg.training.seed)
    ...
    output_dir = os.path.join(model_config.output_dir, "stability", f"seed_{cfg.training.seed}")
